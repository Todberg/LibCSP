...
\img{network_terminology_connections.pdf}{0.65}{Example scenario with active connections using CSP.}
...
\img{overallflow.pdf}{0.6}{Relationship between a socket bound to a port and connections.}
