...
\subsection{Asynchronous Event Handlers and Threading} % (fold)
\label{sub:asynchronous_event_handlers}

% subsection asynchronous_event_handlers (end)
