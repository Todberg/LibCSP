...
\label{chapter:csp}
This section will introduce the Cubesat Space Protocol and show an example of a client/server application that uses the protocol. The chapter is based on \cite{GomSpace, GomSpace:CSP} and extensive inspection of the source code~\cite{GomSpace:CSPsrcGit}.
