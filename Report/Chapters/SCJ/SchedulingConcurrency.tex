...
In SCJ all tasks are implemented as event-handlers and a unit of work to be executed on each release is implemented in the \code{handleAsyncEvent} method that was illustrated in the application example in Section \ref{subsection:handlers}. This method is invoked by the underlying infrastructure. This makes it more easy to perform analysis as well as support static analysis tools.
