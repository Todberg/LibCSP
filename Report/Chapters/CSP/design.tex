...
In the algorithm, \textit{this} and \textit{broadcast} refers to the addresses of the node executing the routing logic and the special address, 31, targeted at every network node.
