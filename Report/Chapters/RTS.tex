...
\begin{eqnarray}
    w_{c}^0 &=& C_{c} = 10 \nonumber \\ 
    w_{c}^1 &=& 10 + \ceil[\bigg]{\frac{18}{23}}*4 + \ceil[\bigg]{\frac{18}{41}}*20 = 34 \nonumber \\ 
    w_{c}^2 &=& 10 + \ceil[\bigg]{\frac{34}{23}}*4 + \ceil[\bigg]{\frac{34}{41}}*20 = 38 \nonumber \\ 
    w_{c}^3 &=& 10 + \ceil[\bigg]{\frac{38}{23}}*4 + \ceil[\bigg]{\frac{38}{41}}*20 = 38 \nonumber \\ 
    R_{c} &=& 38
\end{eqnarray}
