...
\begin{description}
	\item[sw902e12.csp] Contains the \code{CSPManager} and public interfaces for the underlying classes. Client applications access the library only through this package.
	\item[sw902e12.csp.core] Resource pool and all core classes such as \code{Socket} and \code{Connection} are organised in this package.
