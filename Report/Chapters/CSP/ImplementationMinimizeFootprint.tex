...
\lstinputlisting[language=C,label=spacemin,caption=Packet header occupying minimal space through the use of low-level language features (bitfields and union).]{Code/Implementation/min.c}
