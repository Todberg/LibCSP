...
While the RTA test is exact, it is naturally very much restricted because of the assumptions made in the simple task model. Rarely is it the case that several concurrently running tasks is always independent of each other, and synchronization is often involved. For this reason there has been many extensions and variations of the described method to loosen or remove single restrictions in the simple task model. We refer to the cited material for additional information on how one may handle the removal of restrictions.
